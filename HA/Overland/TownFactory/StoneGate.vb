Partial Public Class TownFactory
    ...
    Public Shared Sub StoneGate()
        ...
        For intXctr = 0 To 78
            ...
            Next
        Next
        GenericBuilding(6, 2, 5, 4, Towns.Heading.South, DoorState.closed, Town.Stonegate) ' 1

        ' composite 2 & 3
        GenericBuilding(13, 2, 17, 4, Towns.Heading.South, DoorState.none, Town.Stonegate) ' 2
        GenericBuilding(13, 5, 5, 5, Towns.Heading.North, DoorState.none, Town.Stonegate) ' 3
        m_TownMap(13, 7, Town.Stonegate).CellType = Towns.CellType.grass

        GenericBuilding(5, 11, 15, 4, Towns.Heading.North, DoorState.none, Town.Stonegate) ' 4
        GenericBuilding(21, 12, 7, 4, Towns.Heading.North, DoorState.open, Town.Stonegate) ' 5
        GenericBuilding(22, 7, 7, 4, Towns.Heading.South, DoorState.none, Town.Stonegate) ' 6

        ' composite 7 & 8
        GenericBuilding(32, 3, 6, 7, Towns.Heading.West, DoorState.closed, Town.Stonegate)
        GenericBuilding(37, 6, 5, 4, Towns.Heading.South, DoorState.none, Town.Stonegate)

        GenericBuilding(31, 11, 13, 4, Towns.Heading.North, DoorState.none, Town.Stonegate) ' 9
        GenericBuilding(41, 2, 7, 3, Towns.Heading.South, DoorState.none, Town.Stonegate) ' 10

        ' composite 11 & 12
        GenericBuilding(46, 6, 5, 5, Towns.Heading.West, DoorState.none, Town.Stonegate)
        GenericBuilding(44, 6, 3, 3, Towns.Heading.West, DoorState.closed, Town.Stonegate)
        m_TownMap(46, 7, Town.Stonegate).CellType = Towns.CellType.grass

        GenericBuilding(53, 2, 7, 7, Towns.Heading.West, DoorState.none, Town.Stonegate)  ' 13
        GenericBuilding(61, 4, 5, 4, Towns.Heading.South, DoorState.none, Town.Stonegate) ' 14

        ' composite 15 & 16
        GenericBuilding(52, 11, 5, 5, Towns.Heading.North, DoorState.open, Town.Stonegate)
        GenericBuilding(46, 13, 7, 3, Towns.Heading.East, DoorState.closed, Town.Stonegate)
        m_TownMap(46, 14, Town.Stonegate).CellType = Towns.CellType.door
        m_TownMap(46, 14, Town.Stonegate).DoorState = DoorState.closed

        GenericBuilding(60, 10, 5, 5, Towns.Heading.North, DoorState.none, Town.Stonegate) ' 17

        ' special building at end of town (18)
        GenericBuilding(72, 6, 5, 6, Towns.Heading.North, DoorState.none, Town.Stonegate)
        ...
        GenericBuilding(70, 4, 3, 3, Towns.Heading.West, DoorState.closed, Town.Stonegate)
        GenericBuilding(70, 11, 3, 3, Towns.Heading.West, DoorState.closed, Town.Stonegate)
        GenericBuilding(67, 2, 4, 3, Towns.Heading.West, DoorState.none, Town.Stonegate)
        ...
        GenericBuilding(67, 13, 4, 3, Towns.Heading.North, DoorState.none, Town.Stonegate)
